...
import com.rio.rostry.feature.admin.ui.AdminDashboardScreen
import com.rio.rostry.feature.admin.ui.AdminVerificationScreen
import com.rio.rostry.feature.admin.ui.UserManagementScreen
import com.rio.rostry.feature.admin.ui.AdminUpgradeRequestsScreen
import com.rio.rostry.feature.admin.ui.audit.AdminAuditScreen
import com.rio.rostry.feature.admin.ui.biosecurity.BiosecurityManagementScreen
import com.rio.rostry.feature.admin.ui.commerce.AdminOrderScreen
import com.rio.rostry.feature.admin.ui.commerce.AdminProductScreen
import com.rio.rostry.feature.admin.ui.dispute.AdminDisputeScreen
import com.rio.rostry.feature.admin.ui.dispute.AdminDisputeDetailScreen
import com.rio.rostry.feature.admin.ui.mortality.MortalityDashboardScreen
import com.rio.rostry.feature.admin.ui.monitoring.BiosecurityMonitoringScreen
import com.rio.rostry.feature.admin.ui.monitoring.MortalityMonitoringScreen
import com.rio.rostry.feature.admin.ui.monitoring.AlertManagementScreen
import com.rio.rostry.feature.admin.ui.roles.RoleManagementScreen
import com.rio.rostry.feature.admin.ui.commerce.InvoicesScreen
import com.rio.rostry.feature.admin.ui.analytics.AnalyticsOverviewScreen
import com.rio.rostry.feature.admin.ui.analytics.UserAnalyticsScreen
import com.rio.rostry.feature.admin.ui.analytics.CommerceAnalyticsScreen
import com.rio.rostry.feature.admin.ui.reports.ReportGeneratorScreen
import com.rio.rostry.feature.admin.ui.system.SystemConfigScreen
import com.rio.rostry.feature.admin.ui.system.SystemHealthScreen
import com.rio.rostry.feature.admin.ui.system.FeatureTogglesScreen
...
fun AdminNavHost(
    ...
    NavHost(
        ...
        composable(
            ...
            com.rio.rostry.feature.admin.ui.users.AdminUserDetailScreen(
                userId = userId,
                onNavigateBack = { navController.popBackStack() },
...
private fun mapLegacyRoute(route: String): String = when (route) {
    "admin/verification" -> AdminRoutes.Verification.PENDING
    "admin/dashboard" -> AdminRoutes.DASHBOARD
    "admin/user_management" -> AdminRoutes.Users.LIST
    "admin/biosecurity" -> AdminRoutes.Biosecurity.ZONES
    "admin/mortality_dashboard" -> AdminRoutes.Mortality.DASHBOARD
    "admin/disputes" -> AdminRoutes.Commerce.DISPUTES
    "admin/product_moderation" -> AdminRoutes.Commerce.PRODUCT_MODERATION
    "admin/order_intervention" -> AdminRoutes.Commerce.ORDER_INTERVENTION
    "admin/audit_logs" -> AdminRoutes.Audit.LOGS
    "admin/upgrade_requests" -> AdminRoutes.Verification.UPGRADE_REQUESTS
    "admin/invoices" -> AdminRoutes.Commerce.INVOICES
    // New route mappings
    "admin/analytics" -> AdminRoutes.Analytics.OVERVIEW
    "admin/reports" -> AdminRoutes.Reports.GENERATOR
    "admin/system_config" -> AdminRoutes.System.CONFIG
    "admin/feature_toggles" -> AdminRoutes.System.FEATURE_TOGGLES
    "admin/moderation" -> AdminRoutes.Moderation.QUEUE
    "admin/broadcast" -> AdminRoutes.Communication.BROADCAST
    "admin/bulk_operations" -> AdminRoutes.Bulk.OPERATIONS
    else -> route
}
