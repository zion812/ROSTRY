        ...
        ElevatedCard {
            Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    ...
                    OutlinedButton(onClick = { navController.navigate("scan/qr") }) { Text("Scan QR") }
                }
...
private fun BreedingTab(navController: NavHostController) {
    Column(
        ...
        ElevatedCard { Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                OutlinedButton(onClick = { navController.navigate("monitoring/breeding") }) { Text("Open Breeding Flow") }
                OutlinedButton(onClick = { navController.navigate("monitoring/hatching") }) { Text("Open Hatching") }
            }
        } }
        ElevatedCard { Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                Button(onClick = { navController.navigate("enthusiast/flock_analytics") }) { Text("📊 Flock Analytics") }
            }
        } }
    }
}
...
private fun AnalyticsTab(onOpenReports: () -> Unit, onOpenFeed: () -> Unit) {
    ...
    Column(
        ...
        ElevatedCard { Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            com.rio.rostry.feature.analytics.BarChartView(
                data = listOf(
                    com.rio.rostry.feature.analytics.BarDatum("P1", 0.8f),
                    com.rio.rostry.feature.analytics.BarDatum("P2", 0.6f),
                    com.rio.rostry.feature.analytics.BarDatum("P3", 0.9f)
                ),
                modifier = Modifier.fillMaxWidth()
            )
            Spacer(Modifier.height(8.dp))
            Text("Hatch Success by Batch")
            com.rio.rostry.feature.analytics.LineChartView(
                points = listOf(
                    com.rio.rostry.feature.analytics.LinePoint("B1", 60f),
                    com.rio.rostry.feature.analytics.LinePoint("B2", 72f),
                    com.rio.rostry.feature.analytics.LinePoint("B3", 81f)
                ),
                modifier = Modifier.fillMaxWidth()
            )
            Spacer(Modifier.height(8.dp))
            ...
            com.rio.rostry.feature.analytics.LineChartView(
                points = listOf(
                    com.rio.rostry.feature.analytics.LinePoint("W1", 3f),
                    com.rio.rostry.feature.analytics.LinePoint("W2", 2f),
                    com.rio.rostry.feature.analytics.LinePoint("W3", 1f)
                ),
                modifier = Modifier.fillMaxWidth()
            )
        } }
        ElevatedCard { Column(Modifier.padding(12.dp), verticalArrangement = Arrangement.spacedBy(8.dp)) {
            ...
            com.rio.rostry.feature.analytics.PieChartView(
                slices = listOf(
                    com.rio.rostry.feature.analytics.PieSlice("Trait A", 40f, androidx.compose.ui.graphics.Color(0xFF64B5F6)),
                    com.rio.rostry.feature.analytics.PieSlice("Trait B", 35f, androidx.compose.ui.graphics.Color(0xFF81C784)),
                    com.rio.rostry.feature.analytics.PieSlice("Trait C", 25f, androidx.compose.ui.graphics.Color(0xFFFFB74D))
                ),
                modifier = Modifier.fillMaxWidth()
            )
            Row(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
