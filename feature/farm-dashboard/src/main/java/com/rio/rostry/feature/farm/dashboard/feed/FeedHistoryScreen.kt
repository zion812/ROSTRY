package com.rio.rostry.feature.farm.dashboard.feed
...
import com.rio.rostry.feature.farm.dashboard.FarmDashboardViewModel
...
fun FeedHistoryScreen(
    onNavigateBack: () -> Unit,
    viewModel: FarmDashboardViewModel = hiltViewModel<FarmDashboardViewModel>()
) {
