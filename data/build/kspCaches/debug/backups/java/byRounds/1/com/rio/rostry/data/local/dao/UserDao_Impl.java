...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUserEntity = new EntityInsertionAdapter<UserEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `users` (`id`,`name`,`email`,`phone`,`role`,`createdAt`) VALUES (?,?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfUserEntity = new EntityDeletionOrUpdateAdapter<UserEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`name` = ?,`email` = ?,`phone` = ?,`role` = ?,`createdAt` = ? WHERE `id` = ?";
      }
      ...
      public UserEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new UserEntity(_tmpId,_tmpName,_tmpEmail,_tmpPhone,_tmpRole,_tmpCreatedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Flow<List<UserEntity>> streamAll() {
      ...
      public List<UserEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            final long _tmpCreatedAt;
            _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
            _item = new UserEntity(_tmpId,_tmpName,_tmpEmail,_tmpPhone,_tmpRole,_tmpCreatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
