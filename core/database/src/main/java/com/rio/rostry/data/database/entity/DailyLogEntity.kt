...
data class DailyLogEntity(
     ...
     */
    fun getMediaItems(): List<com.rio.rostry.domain.model.media.SimpleMediaItem> {
        ...
        if (!mediaItemsJson.isNullOrBlank()) {
            try {
                ...
                val items: List<com.rio.rostry.domain.model.media.SimpleMediaItem>? = com.google.gson.Gson().fromJson(mediaItemsJson, type)
