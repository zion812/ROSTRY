...
object ShowcaseValidator {
    ...
    fun canAddToShowcase(role: UserType, currentShowcaseCount: Int): Boolean {
        return when (role) {
            ...
            UserType.ENTHUSIAST, UserType.ADMIN, UserType.SUPPORT, UserType.MODERATOR -> true // Unlimited
    ...
    fun getMaxSlots(role: UserType): Int {
        return when (role) {
            ...
            UserType.ENTHUSIAST, UserType.ADMIN, UserType.SUPPORT, UserType.MODERATOR -> Int.MAX_VALUE
            UserType.GENERAL -> 0
        }
    }
    ...
    fun getUpgradeMessage(role: UserType): String? {
        return when (role) {
            ...
            UserType.ENTHUSIAST, UserType.ADMIN, UserType.SUPPORT, UserType.MODERATOR -> null
        }
    }
}
